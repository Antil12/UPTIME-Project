        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 24px" }}>
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16, fontFamily: T.font, fontSize: 8, letterSpacing: "0.28em", textTransform: "uppercase", color: T.dim }}>
              ...
              <span>Alert System › Escalation Groups</span>
            ...
            <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 20 }}>
              ...
              <div style={{ display: "flex", gap: 10 }}>
                <StatBadge value={groups.length} label="Groups" color={T.accent} />
                <StatBadge value={totalEmails} label="Recipients" color="rgba(167,139,250,0.9)" />
              </div>
            </div>
          </motion.div>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div>
                <div style={{ fontFamily: "'Orbitron', sans-serif", fontWeight: 700, fontSize: 10, letterSpacing: "0.08em", color: "white" }}>ALERT ROUTING PANEL</div>
