...
const Regions = ({ theme }) => {
  ...
  return (
    <>
      ...
      {/* CONTENT */}
      <div className="relative z-10 min-h-screen w-full text-white px-5 sm:px-6 lg:px-10 xl:px-14 py-6 lg:py-8">
        {/* Top Bar */}
        <motion.div
          initial={{ opacity: 0, y: -12 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.45 }}
          className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-7"
        >
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <div className="h-[1px] w-10 bg-sky-400/25" />
            <span
              style={{
                fontFamily: "'JetBrains Mono', monospace",
                fontSize: "9px",
          ...
          <h1
            className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl leading-none mb-3"
            style={{
              fontFamily: "'Orbitron', sans-serif",
              fontWeight: 800,
        ...
        {/* Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-5 pb-6">
